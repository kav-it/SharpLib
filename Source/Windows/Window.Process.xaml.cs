...
namespace SharpLib
{
    ...
    public partial class WindowProcess : Window
    {
        ...
        private Boolean IsExecute
        {
            get 
            {
                return ((_thread.IsStop == true) == false);
            }
            set
            {
                if (value == false)
        ...
        private void WindowLoaded(Object sender, RoutedEventArgs e)
        {
            ...
            _thread.Finished += new ModuleThreadDelegate(OnThreadFinished);
            _thread.StartThread();
        }
        /// <summary>
        /// Окно закрывается
    ...
    public class WindowProcessMessageTypConverter : IValueConverter
    {
        ...
        public Object Convert(Object value, Type targetType, Object parameter, CultureInfo culture)
        {
            ...
            switch (typ)
            {
                case WindowProcessMessageTyp.Warning: return _sourceWarning;
                case WindowProcessMessageTyp.Info: return _sourceInfo;
                case WindowProcessMessageTyp.Error: return _sourceError;
            }
