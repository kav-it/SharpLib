...
namespace SharpLib
{
    #region Перечисление DebugLevel
    [Flags]
    ...
    #endregion Перечисление DebugLevel
    ...
    public class ModuleThreadBase
    {
        ...
        public Boolean IsRun
        {
            get
            {
                return (ThreadState < ModuleThreadState.Stoping);
            }
        }
        public Boolean IsStop
        {
            get 
            { 
                return ThreadState == ModuleThreadState.Stop; 
            }
        }
        #endregion Свойства
        ...
        public ModuleThreadBase(String threadName, ThreadStart threadStart)
        {
            ...
            _eventsWait   = new AutoResetEvent[] {_eventStop, _eventDo};
        ...
        public ThreadWaitResult WaitEvent(int timeout)
        {
            ...
            switch (index)
            {
                case WaitHandle.WaitTimeout: return ThreadWaitResult.Timeout;
                case 0: return ThreadWaitResult.Break;
                case 1:
                    {
                ...
                default: return ThreadWaitResult.Unknow;
            }
        }
    ...
    public class ModuleVersion
    {
        ...
        /// <summary>
        /// Инициализация значениями из текущей сборки
        /// </summary>
        public void UpdateFromAssembly()
        {
        ...
        public static Boolean operator !=(ModuleVersion version_1, ModuleVersion version_2)
        {
            Boolean result = !(version_1 == version_2);
    ...
    public class GuiList<T> : ObservableCollection<T>
    {
        ...
        {
            List<T> result = new List<T>(this.Items);
    ...
    #region Класс Tree
    public class Tree<T> where T : class, IComparer
    {
        #region Поля
        private T             _value;
        private Tree<T>       _parent;
        private List<Tree<T>> _childs;
        #endregion Поля
        ...
        {
            foreach (Tree<T> child in _childs)
            {
