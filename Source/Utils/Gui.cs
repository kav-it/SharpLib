    ...
    public class ImageBase
    {
        ...
        public ImageBase(String name, bool resource) : this()
        {
            ...
            if (resource)
            {
                ...
                data = ResourcesWpf.LoadBuffer(name, assembly);
            }
            else
        ...
        public void Save(String filename, ImageTyp typ)
        {
            if (_image != null)
            {
                ...
                {
                    case ImageTyp.Jpg:
                        _image.Save(filename, System.Drawing.Imaging.ImageFormat.Jpeg);
                        break;
                    case ImageTyp.Bmp:
                    ...
                    case ImageTyp.Gif:
                        ...
                        break;
                    case ImageTyp.Tif:
                        _image.Save(filename, System.Drawing.Imaging.ImageFormat.Tiff);
                        break;
