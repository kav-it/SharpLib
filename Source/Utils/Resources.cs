...
namespace SharpLib
{
    ...
    {
        #region Методы
        public static List<ResourceWpfElement> Enum()
        {
            ...
            if (names.Length > 0)
            {
                ...
                {
                    System.IO.Stream s = assembly.GetManifestResourceStream(names[namesIndex]);
        ...
        public static void Print()
        {
            ...
            List<ResourceWpfElement> list = Enum();
        ...
        public static Stream GetStream(String absolutPath)
        {
        ...
        /// </summary>
        public static String LoadText(String absolutPath)
        {
            Stream stream = GetStream(absolutPath);
        ...
        /// </summary>
        /// <param name="dest">Путь сохранения файла</param>
        /// <param name="source">Путь к файлу в ресурсах. Файл должен быть с параметрами
        /// Build Action = Resource
        /// Copy To Output = Do not copy
        /// </param>
        public static Boolean CopyContent(String absolutPath, String destPath = "")
        {
            // Получение потока нужного ресурса
            Uri uri = new Uri(@"pack://application:,,,/" + absolutPath, UriKind.Absolute);
            StreamResourceInfo streamResource = null;
    ...
    public abstract class ResourceWin
    {
        ...
        public String TypeName
        {
            get
            {
                return (_type.IsIntResource() ? _type.ResourceType.ToString() : _type.Name);
            }
        }
    ...
    public class ResourceWinTableHeader
    {
        ...
        {
            // wLength
            w.Write((UInt16)_header.Length);
            // wValueLength
            w.Write((UInt16)_header.ValueLength);
            // wType
            w.Write((UInt16)_header.Typ);
            // write key
    ...
    public class ResourceWinFixedFileInfo
    {
        ...
        #region Конструктор
        public ResourceWinFixedFileInfo()
        {
        }
        #endregion Конструктор
        ...
        {
            w.Write(ResourcesWin.GetBytes<NativeMethods.VsFixedFileInfo>(_fixedfileinfo));
            ResourcesWin.PadToDword(w);
        }
        public override String ToString()
        {
