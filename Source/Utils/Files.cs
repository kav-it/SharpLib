...
namespace SharpLib
{
    ...
    public static class Files
    {
        ...
        #region Поля
        private static FileError _lastError;
        #endregion Поля

        #region Свойства
        public static FileError LastError
        {
        ...
        /// </summary>
        public static String GetPathRelative(String path_1, String path_2)
        {
            path_1 = AddPathSeparator(path_1);
            path_2 = AddPathSeparator(path_2);

            // Определение минимальной вложенности
            Uri uri_1     = new Uri(path_1);
            Uri uri_2     = new Uri(path_2);
        ...
        internal static void RunExe(String exeName, String param)
        {
