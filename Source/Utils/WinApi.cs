...
namespace SharpLib
{
    ...
    public sealed unsafe class NativeMethods
    {
        ...
        #region Методы импортированные из ntdll.dll
        [DllImport("ntdll.dll")]
        ...
        #endregion Методы импортированные из ntdll.dll

        #region Методы импортированные из kernel32.dll
        ...
        [SecurityCritical, DllImport("kernel32", CharSet = CharSet.Auto, ExactSpelling = true)]
        ...
        internal unsafe static extern UInt32 ReadFile(
            IntPtr hFile,
            Byte* lpBuffer,
        ...
        internal unsafe static extern UInt32 WriteFile(
            IntPtr hFile,
            Byte* lpBuffer,
        ...
        #endregion Методы импортированные из kernel32.dll

        #region Методы импортированные из setupapi.dll
        ...
        #endregion Методы импортированные из setupApi.dll

        #region Методы импортированные из user32.dll
        ...
        [SecurityCritical, DllImport("user32.dll", CharSet = CharSet.Auto)]
        ...
        [SecurityCritical, DllImport("user32.dll", EntryPoint = "GetWindowLong", CharSet = CharSet.Auto, SetLastError = true)]
        private static extern int IntGetWindowLong(HandleRef hWnd, int nIndex);

        [SecurityCritical, DllImport("user32.dll", EntryPoint = "GetWindowLongPtr", CharSet = CharSet.Auto, SetLastError = true)]
        ...
        #endregion Методы импортированные из user32.dll

        #region Методы импортированные из shell32.dll
        [SecurityCritical, DllImport("shell32.dll", EntryPoint = "SHGetMalloc")]
        internal static extern int ShellGetMalloc([Out, MarshalAs(UnmanagedType.LPArray)] IMalloc[] ppMalloc);

        [SecurityCritical, DllImport("shell32.dll", EntryPoint = "SHGetFolderLocation")]
        ...
        [SecurityCritical, DllImport("shell32.dll", EntryPoint = "SHParseDisplayName")]
        ...
        [SecurityCritical, DllImport("shell32.dll", EntryPoint = "SHBrowseForFolder")]
        internal static extern IntPtr ShellBrowseForFolder(ref BrowseInfo lbpi);

        [SecurityCritical, DllImport("shell32.dll", CharSet = CharSet.Auto, EntryPoint = "SHGetPathFromIDList")]
        internal static extern bool ShellGetPathFromIDList(IntPtr pidl, IntPtr pszPath);

        [SecurityCritical, DllImport("shell32.dll", CharSet = CharSet.Auto, EntryPoint = "Shell_NotifyIcon")]
        internal static extern int ShellNotifyIcon(int message, NotifyIconData pnid);
        #endregion Методы импортированные из shell32.dll

        #region Методы импортированные из Mapi32.dll
        ...
        #endregion Методы импортированные из Mapi32.dll
        ...
        private static void RaiseSystemException ()
        {
            ...
            switch (err)
            {
                case ERROR_INVALID_HANDLE: throw new IOException(message);
                case ERROR_FILE_NOT_FOUND: throw new FileNotFoundException(message);
                case ERROR_ACCESS_DENIED:  throw new UnauthorizedAccessException(message);
