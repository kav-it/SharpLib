...
namespace SharpLib
{
    ...
    public class FrameworkVersionInfo
    {
        ...
        public String  VersionString
        {
            get 
            {
                return String.Format("{0} {1}", Version, ServicePack);
            }
        }
    ...
    public class MemoryInfo
    {
        ...
        public UInt64 TotalPhySize
        {
            get
            {
                return _memoryStatus.TotalPhys;
            }
        }
        #endregion Свойства
    ...
    {
        #region Поля
        private static OperatingSystemInfo _oSInfo;
        private static FrameworkInfo _dotNetInfo;
        private static ProcessorInfo _procInfo;
        private static MemoryInfo _memoryInfo;
        private static MonitorInfo _monitorInfo;
        private static HardwareFolders _folders;
        #endregion Поля

        #region Свойства
        public static OperatingSystemInfo OsInfo
        {
            get { return _oSInfo; }
            set { _oSInfo = value; }
        }
        public static FrameworkInfo DotNetInfo
        {
            get { return _dotNetInfo; }
            set { _dotNetInfo = value; }
        }
        public static ProcessorInfo ProcInfo
        {
        ...
        public static HardwareFolders Folders
        {
            get { return _folders; }
            set { _folders = value; }
        }
        ...
        public static List<SerialDeviceInfo> EnumSerial ()
        {
            ...
            String[]    kn     = Registry.LocalMachine.GetSubKeyNames();
            RegistryKey rKey   = Registry.LocalMachine.OpenSubKey("HARDWARE");

            kn   = rKey.GetSubKeyNames();
