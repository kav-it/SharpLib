                ...
                if (effect != DragDropEffects.None)
                {
                    ...
                    if (text != null)
                    {
                        ...
                        else
                        {
                            ...
                            bool rectangular = e.Data.GetDataPresent(RectangleSelection.RECTANGULAR_SELECTION_DATA_TYPE);
                            ...
                            if (rectangular)
                            {
                                pasteFormat = RectangleSelection.RECTANGULAR_SELECTION_DATA_TYPE;
                            }
                            else
                            {
                            ...
                            rectangular = pastingEventArgs.FormatToApply == RectangleSelection.RECTANGULAR_SELECTION_DATA_TYPE;
