...
namespace SharpLib.Texter.Editing
{
    public sealed class RectangleSelection : Selection
    {
        ...
        public const string RECTANGULAR_SELECTION_DATA_TYPE = "SharpLib.Texter.RectangularSelection";
        ...
        public override System.Windows.DataObject CreateDataObject(TextArea textArea)
        {
            ...
            if (EditingCommandHandler.ConfirmDataFormat(textArea, data, RECTANGULAR_SELECTION_DATA_TYPE))
            {
                var isRectangle = new MemoryStream(1);
                isRectangle.WriteByte(1);
                data.SetData(RECTANGULAR_SELECTION_DATA_TYPE, isRectangle, false);
            }
            return data;
        }
