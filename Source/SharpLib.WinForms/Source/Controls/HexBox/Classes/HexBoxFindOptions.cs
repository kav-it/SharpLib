...
namespace SharpLib.WinForms.Controls
{
    ...
    public class HexBoxFindOptions
    {
        ...
        /// <summary>
        /// Gets the Find buffer used for case sensitive Find operations. This is the binary representation of Text in lower case
        /// format.
        /// </summary>
        internal byte[] FindBufferLowerCase { get; private set; }

        /// <summary>
        /// Gets the Find buffer used for case sensitive Find operations. This is the binary representation of Text in upper case
        /// format.
        /// </summary>
