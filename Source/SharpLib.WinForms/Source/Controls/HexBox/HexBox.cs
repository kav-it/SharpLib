...
namespace SharpLib.WinForms.Controls
{
    ...
    public class HexBox : Control
    {
        ...
        /// <summary>
        /// Gets or sets the hex boxґs border style.
        /// </summary>
        [DefaultValue(typeof(BorderStyle), "Fixed3D"), Category("Hex"), Description("Gets or sets the hex boxґs border style.")]
        ...
        /// <summary>
        /// Gets or sets the info color used for column info and line info. When this property is null, then ForeColor property is
        /// used.
        /// </summary>
