...
namespace SharpLib
{
    ...
    {
        #region Свойства
        [Browsable(true), Category("Common"), Description("Минимальное значение")]
        public Double MaxValue
        {
            get { return (Double)GetValue(MaxValueProperty); }
            set { SetValue(MaxValueProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("Максимальное значение")]
        public Double MinValue
        {
            get { return (Double)GetValue(MinValueProperty); }
            set { SetValue(MinValueProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("Текущее значение")]
        public Double Value
        {
            get { return (Double)GetValue(ValueProperty); }
            set { SetValue(ValueProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("Величина изменения")]
        public Double Increment
        {
            get { return (Double)GetValue(IncrementProperty); }
            set { SetValue(IncrementProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("Режим Целые/Дробные значения")]
        public TextUpDownMode Mode
        {
            get { return (TextUpDownMode)GetValue(ModeProperty); }
            set { SetValue(ModeProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("При достижении максимума переходить к минимуму и наоборот")]
        public Boolean RollOver
        {
            get { return (Boolean)GetValue(RollOverProperty); }
            set { SetValue(RollOverProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("Формат отображаемой строки")]
        public String FormatString
        {
            get { return (String)GetValue(FormatStringProperty); }
            set { SetValue(FormatStringProperty, value); }
        }
        [Browsable(true), Category("Common"), Description("Количество вводимых символов")]
