...
namespace SharpLib
{
    ...
    public partial class Memo : UserControl
    {
        ...
        public Memo()
        {
            ...
            PART_richTextBox.Loaded             += new RoutedEventHandler(OnRichBoxLoaded);
            PART_richTextBox.MouseRightButtonUp += new MouseButtonEventHandler(OnRichBoxMouseRightButtonUp);
        }
        ...
        {
            _richTextBoxScrollViewer = (ScrollViewer)TreeVisual.FindDown(typeof(ScrollViewer), "PART_ContentHost", PART_richTextBox);
        }
