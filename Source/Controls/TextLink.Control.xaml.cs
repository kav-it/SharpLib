...
namespace SharpLib
{
    ...
    public partial class TextLink : UserControl
    {
        ...
        static TextLink()
        {
            TextProperty = DependencyProperty.Register("Text", typeof(String), typeof(TextLink), new PropertyMetadata(OnTextPropertyChanged));
            TextColorProperty = DependencyProperty.Register("TextColor", typeof(SolidColorBrush), typeof(TextLink), new PropertyMetadata(OnTextColorPropertyChanged));
