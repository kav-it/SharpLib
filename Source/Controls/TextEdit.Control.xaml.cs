...
namespace SharpLib
{
    ...
    public partial class TextEdit : UserControl
    {
        ...
        [Browsable(true)]
        [Category("Common")]
        [Description("Подпись курсивом, когда текст отсутсвует")]
        ...
        {
            get { return (PART_textBox.Style != null); }
            set
            {
                if (value == false)
                    PART_textBox.Style = null;
                else
                    PART_textBox.Style = (Style)FindResource("textBoxFlatStyle");
            }
        }
        ...
        public TextEdit()
        {
            ...
            // Ввод текста
            PART_textBox.PreviewTextInput += TextBoxPreviewTextInput;
            // Копирование "Paste"
        ...
        private void TextBoxPasting(Object sender, DataObjectPastingEventArgs e)
        {
            if (e.DataObject.GetDataPresent(typeof(String)))
            {
                ...
                if (FilterPreviewTextInput(text))
                    e.CancelCommand();
            }
            else
                e.CancelCommand();
